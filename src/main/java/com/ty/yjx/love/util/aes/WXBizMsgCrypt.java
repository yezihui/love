 ...
 * 官方下载地址：http://commons.apache.org/proper/commons-codec/download_codec.cgi
 */
package com.ty.yjx.love.util.aes;
...
public class WXBizMsgCrypt {
    ...
    public String EncryptMsg(String replyMsg, String timeStamp, String nonce) throws Exception {
        ...
        String signature = Md5Utils.getSha1(sb.toString());
        return XmlUtils.generate(encrypt, signature, timeStamp, nonce);
    }
    ...
    public boolean checkSignature(String signature,String timestamp,String nonce) throws Exception{
        ...
        //sha1加密
        String temp = Md5Utils.getSha1(content.toString());
